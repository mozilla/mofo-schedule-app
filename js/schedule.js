function Schedule(CUSTOM_CONFIG) {
  ...
  schedule.addListControls = function() {
    ...
    $('#list-filter').attr("placeholder", "Search names, facilitators, " + (DISPLAY_NAME_FOR_CATEGORY.plural ? DISPLAY_NAME_FOR_CATEGORY.plural + ", " : "") + (DISPLAY_NAME_FOR_TAG.plural ? DISPLAY_NAME_FOR_TAG.plural + ", " : "") + "and descriptions...");
    $('#list-filter').focus();
